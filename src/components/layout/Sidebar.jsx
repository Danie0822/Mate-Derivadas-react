  ...
  const menuItems = [
    {
      ...
      roles: ['admin', 'user'] // Accesible para ambos roles
    },
    {
      id: 'users',
    ...
    },
    {
      ...
      roles: ['admin', 'user'] // Ambos pueden ver, pero solo admin puede editar
    },
    {
      id: 'study-guides',
    ...
    },
    {
      ...
      roles: ['admin', 'user'] // Accesible para ambos
    },
    {
      id: 'calculator',
      ...
      roles: ['', ''] // Accesible para ambos - sin permisos de momento
    },
    {
      id: 'user-progress',
